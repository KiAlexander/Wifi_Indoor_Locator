...
public class MapViewActivity extends MapActivity {
    public final static String EXTRA_MESSAGE_FLOOR = "com.example.kimyoung.wifi_indoor_locator.FLOOR";
    ...
    public void onReceiveWifiScanResults(final List<ScanResult> results) {
        Wifi_Indoor_Locator application = (Wifi_Indoor_Locator) getApplication();
