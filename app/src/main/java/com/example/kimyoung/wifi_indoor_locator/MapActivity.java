...
public class MapActivity extends Activity implements OnTouchListener {
    ...
    protected Wifi_Indoor_Locator mApplication;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mApplication = (Wifi_Indoor_Locator) getApplication();
        mWifi = (WifiManager) getSystemService(Context.WIFI_SERVICE);

        this.setMap(R.drawable.library); // set map to default location (== first floor)
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENU_ITEM_1STFLOOR:
                setMap(R.drawable.library);
                return true;
            case MENU_ITEM_2NDFLOOR:
                setMap(R.drawable.dorm6);
                return true;
            case MENU_ITEM_3RDFLOOR:
                setMap(R.drawable.teachingbuiding3);
                return true;
